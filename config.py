...
# ID Channel Database
CHANNEL_DB = int(os.environ.get("CHANNEL_DB", "-1002018126622"))

# Database
DATABASE_URL = os.environ.get("DATABASE_URL", "postgres://nbzwwudg:ralDkzuoWa1dlEpOXgfVh1W2ZLEaANiw@rosie.db.elephantsql.com/nbzwwudg")
...
try:
    ADMINS = [int(x) for x in (os.environ.get("ADMINS", "5030620281").split())]
except ValueError:
